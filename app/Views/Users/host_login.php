...
<head>
    ...
    <link href="<?= getenv('app.baseURL') ?>/public/Font-Awesome-Pro/include/css/all.min.css" rel="stylesheet">
...
<body>
            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="post">
                    ...
                    <center class="my-2">
                        ...
                        <a id="other_login" href="<?= getenv('app.baseURL') ?>/Auth" class="text-muted"><i class="far fa-long-arrow-alt-left"></i> User Login</a>
                    </center>
                </form>
            </div>
        </div>
    ...
    <script>
        function onSignIn(googleUser) {
            ...
            if (id_token) {
                $("body").append(`
                <form method="post" id="google_login" action="<?= getenv('app.baseURL') ?>/Auth/HostLoginHandler">
